<cfcomponent extends="Gateway">
    ...
    <cfset fields=array(
		...
		,field("Change","changeFunction","onChange",false,"called when a file change","text")
		,field("Add","addFunction","onAdd",false,"called when a file is added","text")
		,field("Delete","deleteFunction","onDelete",false,"called when a file is removed","text")
