...
<tr>
	...
	<td width="200"><cfinput type="password" name="new_password" value="" passthrough='autocomplete="off"'
...
<tr>
	...
	<td width="200"><cfinput type="password" name="new_password_re" value="" passthrough='autocomplete="off"'
...
<tr>
	...
	<td width="200"><select name="lang" onchange="changePic(this.options[this.selectedIndex].value)">
