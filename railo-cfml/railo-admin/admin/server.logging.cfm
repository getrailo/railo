...
<cfset layouts={}>
<cfset names=structnew("linked")>
<cfset names=ComponentListPackageAsStruct("railo-server-context.admin.ldriver.layout",names)>
<cfset names=ComponentListPackageAsStruct("railo-context.admin.ldriver.layout",names)>
<cfset names=ComponentListPackageAsStruct("ldriver.layout",names)>
<cfloop collection="#names#" index="n" item="fn">
