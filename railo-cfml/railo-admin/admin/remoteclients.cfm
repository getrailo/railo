		...
		<tr>
			<td colspan="#attributes.colspan#" class="tblHead">
				<table class="tbl" width="100%">
					<tr>
						<td style="background-color:white" onclick="dumpOC('_remoteclient#request.recount#')">
							<script>
							...
							<table>
								<tr>
									...
									<td>#caller.stText.remote.sync.title#<br />
										<div class="comment">#caller.stText.remote.sync.desc# <cfif len(attributes.attention)><br /><br /><span style="color:red">#attributes.attention#</span></cfif></div>
									</td>
								</tr>
							</table>
						</td>
