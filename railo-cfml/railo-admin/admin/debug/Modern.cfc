	...
	<cffunction name="output" returntype="void">
		...
		<cfoutput>
			...
			<style type="text/css">
				...
				##-railo-err .underline { text-decoration: underline; }
				##-railo-err .underline.selected, .underline:hover { background-color: ##222; color: ##FFF; }
			...
			<!-- Railo Debug Output !-->
			<fieldset id="-railo-err" class="#arguments.custom.size#">
