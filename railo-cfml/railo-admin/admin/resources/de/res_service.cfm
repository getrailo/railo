...
<cfset stText.Settings.PreserveSingleQuotesDescription = "Erh￤lt die einfachen Anf￼hrungszeichen (') in den SQL-Statements, die im Tag CFQuery definiert werden.">
