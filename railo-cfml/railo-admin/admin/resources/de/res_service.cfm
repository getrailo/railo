...
<cfset stText.Settings.PreserveSingleQuotesDescription = "Verdoppelt die einfachen Anführungszeichen (') in den SQL-Statements, die im Tag CFQuery definiert werden. Wenn diese Option eingeschaltet ist verdoppelt Railo alle einfache Anführungszeichen. Achtung dies macht ihr Code angreifbar für ""cross site scripting attacks""">
...
<cfset stText.remote.next="nächste">
