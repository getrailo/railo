...
<cfset stText.remote.adminPasswordDesc.web    = "Password f￼r the access to the remote Railo Web Administrator">
<cfset stText.remote.adminPasswordDesc.server = "Password f￼r the access to the remote Railo Server Administrator">
