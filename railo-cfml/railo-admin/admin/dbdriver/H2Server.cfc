<cfcomponent extends="Driver" implements="IDriver">
	...
	<cfset fields = array(
		...
		field( "mode", "mode", "HSQLDB,MSSQL,MySQL,PostgreSQL", true, "All database engines behave a little bit different. For certain features, this database can emulate the behavior of specific databases. Not all features or differences of those databases are implemented. Currently, this feature is mainly used for randomized comparative testing","radio")
	)>
