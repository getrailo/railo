...
<tr>
	<td class="tblHead" width="150">#stText.Debug.DebugOptions#</td>
	<td class="tblContent" height="28">
		<input type="Checkbox">&nbsp;<span class="comment">Show occured errors</span><br>
		<input type="Checkbox">&nbsp;<span class="comment">Show traces</span><br>
		<input type="Checkbox">&nbsp;<span class="comment">Show timers</span><br>
	</td>
</tr>
...
<h2>#stText.Debug.DebugTemplates#</h2>
<table class="tbl">
	<tr>
		<td><input class="checkbox" name="rro" onclick="selectAll(this)" type="checkbox"><table width="10" border="0" cellpadding="0" cellspacing="0" height="1"><tbody><tr><td width="10" height="1"></td></tr></tbody></table></td>
		<td><table width="17" border="0" cellpadding="0" cellspacing="0" height="1"><tbody><tr><td width="17" height="1"></td></tr></tbody></table></td>
		<td class="tblHead" nowrap="nowrap">From IP address</td>
		<td class="tblHead" nowrap="nowrap">To IP address</td>
		<td class="tblHead" nowrap="nowrap">Debugging template</td>
	</tr>
<tr>
		<td><table border="0" cellpadding="0" cellspacing="0">
		<tbody><tr>
			<td><input class="checkbox" name="row_4" value="4" type="checkbox"></td>
		</tr>

		</tbody></table></td>
		
		<td><table width="17" border="0" cellpadding="0" cellspacing="0" height="1"><tbody><tr><td width="17" height="1"></td></tr></tbody></table></td>
		<td class="tblContent" nowrap="nowrap"><input type="Text" size="1" maxlength="3" value="*">.<input type="Text" size="1" maxlength="3" value="*">.<input type="Text" size="1" maxlength="3" value="*">.<input type="Text" size="1" maxlength="3" value="*"></td>
		<td class="tblContent" nowrap="nowrap"><input type="Text" size="1" maxlength="3" value="*">.<input type="Text" size="1" maxlength="3" value="*">.<input type="Text" size="1" maxlength="3" value="*">.<input type="Text" size="1" maxlength="3" value="*"></td>
		<td class="tblContent" nowrap="nowrap">
...
<tr>
	...
	<td class="tblContent#css#" title="#debug.strDebugTemplate# #debug.DebugTemplate#">
