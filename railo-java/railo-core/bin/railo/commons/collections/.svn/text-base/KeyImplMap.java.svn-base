 ...
 */
public final class KeyImplMap  implements  Cloneable,
     ...
     */
    public KeyImplMap(int initialCapacity, float loadFactor) {
     ...
     *              than zero.
     */
    public KeyImplMap(int initialCapacity) {
...
*
     ...
     * @see     #get(Object)
     */
    public Object put(Object key, Key value) {
    ...
    public Object clone() {
    try { 
        KeyImplMap t = (KeyImplMap)super.clone();
...
*
    ...
    private class KeySet extends AbstractSet {
        ...
        public boolean remove(Object o) {
            return KeyImplMap.this.remove(o) != null;
        }
        /**
         * @see java.util.Set#clear()
         */
        public void clear() {
            KeyImplMap.this.clear();
        }
    }
...
*
     ...
     * @param next
     */
    protected Entry(int hash, Object key, Key value, Entry next) {
        this.hash = hash;
        this.key = key;
        this.value = value;
        this.next = next;
    ...
    Entry[] table = KeyImplMap.this.table;
    ...
    public Object nextElement() {
        ...
        throw new NoSuchElementException("not impl");
    }
    ...
    public void remove() {
        ...
        synchronized(KeyImplMap.this) {
        Entry[] tab = KeyImplMap.this.table;
