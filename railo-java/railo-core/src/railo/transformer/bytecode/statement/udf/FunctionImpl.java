...
public final class FunctionImpl extends Function {
	...
	public FunctionImpl(Expression name, Expression returnType, Expression returnFormat, Expression output, Expression abstr,
	...
	public FunctionImpl(String name, int access, String returnType, Body body,int startline, int endline) {
