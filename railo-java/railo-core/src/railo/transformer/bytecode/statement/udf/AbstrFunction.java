...
public abstract class AbstrFunction extends StatementBase implements Opcodes, IFunction,HasBody {
	...
	public AbstrFunction(String name,int access,String returnType,Body body,int startline,int endline) {
	...
	public AbstrFunction(Expression name,Expression returnType,Expression returnFormat,Expression output,Expression abstr,
	...
	public final void createUDFProperties(BytecodeContext bc, int index, boolean onlyProps) throws BytecodeException {
