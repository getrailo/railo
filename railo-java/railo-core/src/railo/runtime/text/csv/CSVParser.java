...
public final class CSVParser {
	 ...
	 */
	 public static Query toQuery(String csv,char delimiter, char textQualifier,String[] headers, boolean firstrowasheaders) throws DatabaseException, CSVParserException, PageException {
	 ...
	 * @throws CSVParserException
	 */
	private static String[] readFirstLine(CFMLString cfmlStr, char delimiter, char textQualifier) throws CSVParserException {
	 ...
	 * @throws PageException
	 */
	private static void readLine(CFMLString cfmlStr, char delimiter, char textQualifier, Array[] arrays) throws CSVParserException, PageException {
        //print.ln("-----------------");
	 ...
	 * @throws CSVParserException
	 */
	private static String readValue(CFMLString cfmlStr,char delimiter,char textQualifier) throws CSVParserException {
