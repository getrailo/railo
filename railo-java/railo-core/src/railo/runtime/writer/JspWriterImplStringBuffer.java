 ...
 */
public class JspWriterImplStringBuffer extends CFMLWriter { 
     ...
     */
    public JspWriterImplStringBuffer(HttpServletResponse response, int bufferSize, boolean autoFlush) {
     ...
     * @param response Response Object
     */
    public JspWriterImplStringBuffer(HttpServletResponse response) {
