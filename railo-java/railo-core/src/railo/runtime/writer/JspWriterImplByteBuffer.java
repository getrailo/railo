 ...
 */
public class JspWriterImplByteBuffer extends CFMLWriter { 
     ...
     */
    public JspWriterImplByteBuffer(HttpServletResponse response, int bufferSize, boolean autoFlush) {
        super(bufferSize, autoFlush);
        this.response=response;
        this.autoFlush=autoFlush;
        this.bufferSize=bufferSize;
        charset = response.getCharacterEncoding();
        buffer=new ByteBuffer(charset,BUFFER_SIZE);
     ...
     * @param response Response Object
     */
    public JspWriterImplByteBuffer(HttpServletResponse response) {
