...
public class ComponentCacheEventListener implements CacheEventListener {
	...
	private static final Collection.Key ON_EXPIRES = KeyImpl.init("onExpires");
	private static final Collection.Key ON_PUT = KeyImpl.init("onPut");
	private static final Collection.Key ON_REMOVE = KeyImpl.init("onRemove");
