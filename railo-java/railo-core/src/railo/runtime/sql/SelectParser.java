...
private ValueDate date(ParserString raw) throws SQLParserException {
	...
	public static void main(String[] args) {
		...
		*/
		...
		//railo.print.out(new SelectParser().parse("select * from qryData where tableName like '%@_array' or x=1").toString());
		//railo.print.out(new SelectParser().parse("select * from qryData where tableName like '%@_array' escape '@' or x=1").toString());
