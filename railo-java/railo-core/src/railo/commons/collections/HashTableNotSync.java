 ...
 */
public final class HashTableNotSync extends Dictionary implements Map, Cloneable,
     ...
     */
    public HashTableNotSync(int initialCapacity, float loadFactor) {
     ...
     *              than zero.
     */
    public HashTableNotSync(int initialCapacity) {
...
*
    ...
    public Object clone() {
    try { 
        HashTableNotSync t = (HashTableNotSync)super.clone();
...
*
    ...
    private class KeySet extends AbstractSet {
        ...
        public boolean remove(Object o) {
            return HashTableNotSync.this.remove(o) != null;
        }
        @Override
        public void clear() {
            HashTableNotSync.this.clear();
        }
    }
...
*
    ...
    Entry[] table = HashTableNotSync.this.table;
    ...
    public void remove() {
        ...
        synchronized(HashTableNotSync.this) {
        Entry[] tab = HashTableNotSync.this.table;
