 ...
 */
public final class HTNS extends Dictionary implements Map, Cloneable,
     ...
     */
    public HTNS(int initialCapacity, float loadFactor) {
     ...
     *              than zero.
     */
    public HTNS(int initialCapacity) {
...
*
    ...
    private class KeySet extends AbstractSet {
        ...
        public boolean remove(Object o) {
            return HTNS.this.remove(o) != null;
        }
        /**
...
*
    ...
    public void remove() {
        ...
        synchronized(HTNS.this) {
        Entry[] tab = HTNS.this.table;
