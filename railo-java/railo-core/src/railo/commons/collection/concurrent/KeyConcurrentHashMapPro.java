 ...
 */
public class KeyConcurrentHashMapPro<V> extends AbstractMapPro<railo.runtime.type.Collection.Key, V>
    ...
    transient Set<railo.runtime.type.Collection.Key> keySet;
    transient Set<Map.Entry<railo.runtime.type.Collection.Key,V>> entrySet;
    ...
    static final class HashEntry<V> {
        final railo.runtime.type.Collection.Key key;
        final int hash;
        volatile V value;
        final HashEntry<V> next;

        HashEntry(railo.runtime.type.Collection.Key key, int hash, HashEntry<V> next, V value) {
            this.key = key;
            this.hash = hash;
            this.next = next;
            this.value = value;
    ...
    static final class Segment<V> extends ReentrantLock implements Serializable {
        ...
        V getE(Map<railo.runtime.type.Collection.Key,V> map,Object key, int hash) throws PageException {
            if (count != 0) { // read-volatile
                HashEntry<V> e = getFirst(hash);
                while (e != null) {
        ...
        boolean replace(railo.runtime.type.Collection.Key key, int hash, V oldValue, V newValue) {
            lock();
            try {
                HashEntry<V> e = getFirst(hash);
        ...
        V replace(railo.runtime.type.Collection.Key key, int hash, V newValue) {
            lock();
            try {
                HashEntry<V> e = getFirst(hash);
                while (e != null && (e.hash != hash || !key.equals(e.key)))
        ...
        V repl(railo.runtime.type.Collection.Key key, int hash, V newValue, RefBoolean replaced) {
            lock();
            try {
                HashEntry<V> e = getFirst(hash);
                while (e != null && (e.hash != hash || !key.equals(e.key)))
        ...
        V put(railo.runtime.type.Collection.Key key, int hash, V value, boolean onlyIfAbsent) {
            lock();
            try {
                int c = count;
     ...
     * @param m the map
     */
    public KeyConcurrentHashMapPro(Map<? extends railo.runtime.type.Collection.Key, ? extends V> m) {
	...
	@Override
	public V g(railo.runtime.type.Collection.Key key) throws PageException {
		int hash = hash(key);
	...
	@Override
	public V g(railo.runtime.type.Collection.Key key, V defaultValue) {
		int hash = hash(key);
	...
	@Override
	public V r(railo.runtime.type.Collection.Key key) throws PageException {
		int hash = hash(key);
	...
	@Override
	public V r(railo.runtime.type.Collection.Key key, V defaultValue) {
		int hash = hash(key);
     ...
     * @see #keySet()
     */
    public Enumeration<railo.runtime.type.Collection.Key> keys() {
    ...
    final class WriteThroughEntry
        extends AbstractMap.SimpleEntry<railo.runtime.type.Collection.Key,V>
    {
        WriteThroughEntry(railo.runtime.type.Collection.Key k, V v) {
            super(k,v);
        }
    ...
    private void readObject(java.io.ObjectInputStream s)
        ...
        for (;;) {
        	railo.runtime.type.Collection.Key key = (railo.runtime.type.Collection.Key) s.readObject();
