<cfscript>
	/**
	* 
	* This is a sample skin file for the Railo DumpTemplate. You can copy this file into a new one in the same location and 
	...
	* */
	...
	stClasses = { 
		...
		stBaseClasses : {
			tdBase:{		style:'.tdBase {border: 0px;padding: 4px;vertical-align: top;}'},
			...
			baseHeader:{	style:'.baseHeader {border: 0px solid ##000;padding: 4px;text-align: left;vertical-align: top;cursor:pointer;display:table-caption;margin: 0px 0px -1px 0px;}'},
