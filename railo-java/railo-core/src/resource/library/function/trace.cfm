<cffunction name="trace" output="no" returntype="void" hint="Displays and logs debugging data about the state of an application at the time this function executes. 
